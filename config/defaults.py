...
cfg.MODELS.TRANSFORMER.ENC_LAYERS = 4
cfg.MODELS.TRANSFORMER.DEC_LAYERS = 5
...
cfg.LOSS = CN()
cfg.LOSS.LOSSES = ['vp1','vp1_labels']#,'vp2_labels']#,'vp3_labels']
...
cfg.DATASETS.NUM_INPUT_LINES = 250
