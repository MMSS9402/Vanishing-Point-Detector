...
from datasets import build_matterport_dataset,build_scannet_dataset,build_su3_dataset,build_yud_dataset
...
def main(cfg):
    ...
    checkpoint = torch.load('/home/kmuvcl/CTRL-C/yudloog/checkpoint0078.pth', map_location='cpu')
